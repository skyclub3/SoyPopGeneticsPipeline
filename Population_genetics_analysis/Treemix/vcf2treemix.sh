...
#         --temp /data2/yycho/JY_Calling_v5/gResults/GatherVcfs/BEAGLE/Treemix/tmp \
...
plink --bfile $file --make-bed --out $file --allow-no-sex --allow-extra-chr  --chr-set 20 no-xy --double-id


plink --bfile  $file --freq --missing --within $2 --out $file --allow-no-sex --allow-extra-chr  --chr-set 20 no-xy --double-id
